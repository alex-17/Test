    ...
    methods: {
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit.validationSubmit", function (e) {
          ...
          if(options.otherValidResult != null){
              var next = true;
              $.each(options.otherValidResult, function (i, obj) {
                  if(obj == false){
                      next = false;
                      return false;
                  }
        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("minlength") !== undefined) {
              message = "至少输入" + $this.attr("minlength") + " 位<!-- data-validation-minlength-message to override -->";
      ...
      ajax: {
        ...
        includeEmpty: true
          ...
          result.message = "至少输入 " + result.minlength + " 位";
          if ($this.data("validation" + name + "Message")) {
            result.message = $this.data("validation" + name + "Message");
          }
